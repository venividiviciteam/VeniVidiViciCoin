...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("venividivici-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("venividivici-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "venividivici " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    	{"198.50.219.220", "198.50.219.220"},
	{"192.95.6.30", "192.95.6.30"},
        {"5.39.8.194","5.39.8.194"},
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("venividivici-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("venividivici-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("venividivici-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("venividivici-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. venividivici is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("venividivici-start");
